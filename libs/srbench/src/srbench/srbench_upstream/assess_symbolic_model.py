...
def assess_symbolic_model(
    dataset, results_path, random_state, est_name, target_noise=0.0, feature_noise=0.0
):

    print(
        40 * "=", "Assessing " + est_name + " model for ", dataset, 40 * "=", sep="\n"
    )
