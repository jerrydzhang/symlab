...
def _inspect(model, tokenizer, opset, tracker, device, n_test, seed,
    ...
    for i, sample in enumerate(test_samples):
        ...
        rows.append({
            ...
            "r2": r2_val, "first_mismatch": fmp, "exact": fmp == -1,
    ...
    for r in rows:
        ...
        print(f"[{r['i']:3d}]{ex}{eq}[{tag}] {r2s} need={r['need_at_end']:+d} "
    ...
    summary = {
        ...
        "n_func_equiv": n_equiv, "mean_r2_valid": mean_r2,
        "n_high_r2": n_high_r2, "categories": str(dict(cat_counts)),
    }
